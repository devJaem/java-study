...
public class Application2 {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		 ...
		 //변수 15개를 사용하는것과 똑같다고 생각하면 된다.
		 //배열은 []기호 안에 있는 숫자 대신 변수를 사용할 수 있다.
		 //따라서 반복문 사용이 가능해진다.
		...
		//배열의 갯수만큼 배엘에 하나씩 반복적으로 접근하기 위한 용도의 반복문
		for(int i = 0; i < iarr.length; i++) {
			
			//명. 각 배열에 접근했을 때 해당 배열의 값을 처음 인덱스부터 차례로 접근하며 출력해주는 반복문
			for(int j = 0; j < iarr[i].length; j++) {
